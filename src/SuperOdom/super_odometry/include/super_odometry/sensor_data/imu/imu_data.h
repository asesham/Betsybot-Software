...
public:
  ...
  void imuInit(MapRingBuffer<Imu::Ptr> imuBuf) {
    ...
    //msg<<"IMU Data Summary"<<std::endl;
    //msg<<"Gravity: "<<gravity.transpose()<<std::endl;
    //msg<<"Gyroscope Bias: "<<gyr_bias.transpose()<<std::endl;
    //msg<<"Accelerometer Bias: "<<acc_bias.transpose()<<std::endl;
    //msg<<"Accelerometer Mean: "<<acc_mean.transpose()<<std::endl;
    //msg<<"IMU Frequency: "<<imu_frequency<<" Hz"<<std::endl;
    //msg<<"pitch offset gravity: "<<pitch_offset_gravity*180/M_PI<<std::endl;
    //msg<<"roll offset gravity: "<<roll_offset_gravity*180/M_PI<<std::endl;
    //msg<<"Roll Pitch Gravity Matrix: "<<Roll_Pitch_Gravity_Matrix<<std::endl;

    //RCLCPP_INFO_STREAM(get_logger("rclcpp"), msg.str());
